...
* [Keycloak](https://en.wikipedia.org/wiki/Keycloak): It's an open source software product to allow single sign-on with identity and access management aimed at modern applications and services.
